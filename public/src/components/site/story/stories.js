export default [
  ...
  },
  {
    ...
    "provides the ability to carry out edits on a MongoDB database " +
    "as a series of steps. If an error occurs on any of the steps, the database is " +
    "returned to its initial state (its state before the transaction started). It is " +
    "based on the two phase commit system described in the MongoDB docs. I wrote a " +
